...
class AddQuestion():
	...
	def add(new_question):
		...
		add_question_to_db(location_type, location, send_times, q_id, subject, question, open_at, close_at)
...
def add_question_to_db(location_type, location, send_times, *data):
	...
	columns_question = '(question_id, subject, question, start_time, end_time, send_times, location)'
